...
dnn_keras_model.add(layers.Dense(units=400,input_dim=8,activation='relu'))#tworzona jest warstwa wejściowa
dnn_keras_model.add(layers.Dense(units=400,activation='relu'))#druga warstwa
dnn_keras_model.add(layers.Dense(units=400,activation='relu'))#druga warstwa
